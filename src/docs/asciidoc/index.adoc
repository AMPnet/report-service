...
.Request
include::{snippets}/ReportingControllerTest/mustBeAbleToGeneratePdfForUserTransactions/http-request.adoc[]
.Response
include::{snippets}/ReportingControllerTest/mustBeAbleToGeneratePdfForUserTransactions/http-response.adoc[]
